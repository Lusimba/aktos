...
class ConsumerListAPIView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        min_previous_jobs_count = self.request.query_params.get(
            "min_previous_jobs_count"
        )
        ...
        max_previous_jobs_count = self.request.query_params.get(
            "max_previous_jobs_count"
        )
